...
If $array[v] < 0$ it means that v is the root of a tree and a representative of set. As not to waste space, we use this negative number to assign a value to this set. $|array[v]|$ is the assigned value.
