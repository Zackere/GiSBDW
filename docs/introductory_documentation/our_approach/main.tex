...
Let $w=\varepsilon$ (empty word). For each $H$ such that $H$ is a leaf of $T_w$, if $lbtd(H)+depth_{T_w}(H)$ is bigger than currently best known upper-bound of $td(G)$, then:
\begin{enumerate}
